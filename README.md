...
Скрипт на PowerShell для пакетного запуска или остановки заранее определенных служб Microsoft Windows. No big deal — хотел поупражняться в языке и немного автоматизировать рутину.
...
Да. Если выполнить Launcher.ps1 без прав администратора — скрипт потребует их, а потом перезапустит сам себя.
